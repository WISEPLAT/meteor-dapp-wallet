...
/**
Config for the wiseplat connector
...
wiseplatConfig = {
    ...
    @property wiseplatConfig.rollBackBy
    */
    rollBackBy: 0,
    /**
    Number of blocks to confirm a wallet

    @property wiseplatConfig.requiredConfirmations
    */
    requiredConfirmations: 12,
    /**
    The default daily limit used for simple accounts

    @property wiseplatConfig.dailyLimitDefault
    */
...
connectToNode = function(){
    ...
    if (WshAccounts.find().count() > 0) {
        checkForOriginalWallet();
    }

    // WshBlocks.detectFork(function(oldBlock, block){
    ...
    //         if(wallet.creationBlock + wiseplatConfig.requiredConfirmations >= block.number)
