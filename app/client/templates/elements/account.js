...
Template['elements_account'].helpers({
    ...
    */
    'account': function(){
        return WshAccounts.findOne(this.account) || Wallets.findOne(this.account) || CustomContracts.findOne(this.account);
    },
    /**
    Get all tokens
    ...
    'new': function() {
        if(this.new) {
            ...
            Meteor.setTimeout(function() {
                WshAccounts.update(id, {$unset: {new: ''}});
    ...
    */
    'creating': function(){
        ...
        var belowReorgThreshold = (blocksForConfirmation >= WshBlocks.latest.number - (this.creationBlock - 1));
        var blockNumberCheck = WshBlocks.latest.number - (this.creationBlock - 1) >= 0;
    ...
    */
    'unConfirmed': function() {
        ...
        var currentBlockNumber = WshBlocks.latest.number,
