...
Template['layout_header'].helpers({
    ...
    */
    'formattedBlockNumber': function() {
        return numeral(WshBlocks.latest.number).format('0,0');
    },
    /**
    ...
    */
    'timeSinceBlock': function () {
        ...
        if (WshBlocks.latest.timestamp == 0 
            || typeof WshBlocks.latest.timestamp == 'undefined')   
            return false;

        var timeSince = moment(WshBlocks.latest.timestamp, "X");
        var now = moment();
